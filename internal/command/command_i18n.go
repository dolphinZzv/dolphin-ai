...
func init() {
	i18n.Register("command",
		"en", i18n.Dict{
			...
			"session_stop":        "Stop the current turn",
			"session_pause":       "Pause the current turn (resume with /session continue)",
			"session_resume":      "Resume the paused turn",
			"session_stopped_msg": "⏹ Stopped — turn aborted.",
			"session_paused_msg":  "⏸ Paused — resume with /session continue.",
		...
		"zh", i18n.Dict{
			...
			"session_stop":        "停止当前任务",
			"session_pause":       "暂停当前任务（用 /session continue 恢复）",
			"session_resume":      "恢复暂停的任务",
			"session_stopped_msg": "⏹ 已停止 — 任务已中止。",
			"session_paused_msg":  "⏸ 已暂停 — 输入 /session continue 继续。",
			"session_resumed_msg": "▶ 已继续。",
