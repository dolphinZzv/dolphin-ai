...
配置文件（config.yaml）将被保留。`,
	...
	KeyCmdSkillsShowUse:        "show <名称>",
	KeyCmdSkillsShowShort:      "查看技能内容",
	KeyCmdCommandsUse:          "commands",
	KeyCmdCommandsShort:        "列出和管理用户自定义指令",
	KeyCmdCommandsListUse:      "list",
	KeyCmdCommandsListShort:    "列出所有用户自定义指令",
	KeyCmdCommandsNewUse:       "new <名称> [描述]",
	KeyCmdCommandsNewShort:     "创建指令模板",
	KeyCmdCommandsDeleteUse:    "delete <名称>",
	KeyCmdCommandsDeleteShort:  "删除指令",
	KeyCmdCommandsShowUse:      "show <名称>",
	KeyCmdCommandsShowShort:    "查看指令内容",
...
示例:
  ...
  dolphin update v1.0.0   更新到指定版本`,
	...
	KeyCmdWorkflowShort:        "列出和管理工作流",
	KeyCmdWorkflowListUse:      "list",
	KeyCmdWorkflowListShort:    "列出所有工作流",
	KeyCmdWorkflowShowUse:      "show <name>",
	KeyCmdWorkflowShowShort:    "显示工作流内容",
	KeyCmdWorkflowNewUse:       "new <name> [description]",
	KeyCmdWorkflowNewShort:     "从模板创建工作流",
	KeyCmdWorkflowDeleteUse:    "delete <name>",
	KeyCmdWorkflowDeleteShort:  "永久删除工作流",
	KeyCmdWorkflowDisableUse:   "disable <name>",
	KeyCmdWorkflowDisableShort: "禁用工作流",
	KeyCmdWorkflowEnableUse:    "enable <name>",
	KeyCmdWorkflowEnableShort:  "启用被禁用的工作流",
	KeyWorkflowCLINone:         "暂无工作流。",
	KeyWorkflowCLITotal:        "总计: %d 个工作流",
	KeyWorkflowCLICreated:      "工作流 %q 已创建到 %s。",
	KeyWorkflowCLIDisabled:     "工作流 %q 已禁用。",
