...
Config files (config.yaml) are preserved.`,
	...
	KeyCmdSkillsShowUse:        "show <name>",
	KeyCmdSkillsShowShort:      "Show skill content",
	KeyCmdCommandsUse:          "commands",
	KeyCmdCommandsShort:        "List and manage user-defined commands",
	KeyCmdCommandsListUse:      "list",
	KeyCmdCommandsListShort:    "List all user-defined commands",
	KeyCmdCommandsNewUse:       "new <name> [description]",
	KeyCmdCommandsNewShort:     "Create a new command template",
	KeyCmdCommandsDeleteUse:    "delete <name>",
	KeyCmdCommandsDeleteShort:  "Delete a command",
	KeyCmdCommandsShowUse:      "show <name>",
	KeyCmdCommandsShowShort:    "Show command content",
	KeyCmdMCPUse:               "mcp",
...
Examples:
  ...
  dolphin update v1.0.0   Update to a specific version`,
	...
	// Workflow CLI output
	KeyCmdWorkflowUse:          "workflow",
	KeyCmdWorkflowShort:        "List and manage workflows",
	KeyCmdWorkflowListUse:      "list",
	KeyCmdWorkflowListShort:    "List all workflows",
	KeyCmdWorkflowShowUse:      "show <name>",
	KeyCmdWorkflowShowShort:    "Show workflow content",
	KeyCmdWorkflowNewUse:       "new <name> [description]",
	KeyCmdWorkflowNewShort:     "Create a new workflow from a template",
	KeyCmdWorkflowDeleteUse:    "delete <name>",
	KeyCmdWorkflowDeleteShort:  "Permanently delete a workflow",
	KeyCmdWorkflowDisableUse:   "disable <name>",
	KeyCmdWorkflowDisableShort: "Disable a workflow",
	KeyCmdWorkflowEnableUse:    "enable <name>",
	KeyCmdWorkflowEnableShort:  "Enable a disabled workflow",
	KeyWorkflowCLINone:         "No workflows found.",
	KeyWorkflowCLITotal:        "Total: %d workflow(s)",
	KeyWorkflowCLICreated:      "Created workflow %q in %s.",
	KeyWorkflowCLIDisabled:     "Disabled workflow %q.",
